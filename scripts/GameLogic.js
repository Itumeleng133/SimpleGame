...
function generateComputerMove(userMove) {
    ...
    // Calling another function to compare the moves
    compareChoices(userMove, computerMove);
}

// Function 2: Comapring the user and computer moves
...
function updateScore(aResult) {
    ...
    // Storing thhe updated scores in the Local Storage object
    // Local Storage works with text only [Use JSON.stringfy() to convert the score object into text]
...
function resetScore() {
    ...
    // Deleting the saved score from the localStorage object
...
function fetchExistingScore() {
    ...
    // Getting data from the localStorage and converting it back to javaScript object
